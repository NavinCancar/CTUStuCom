                        ...
                        <div class="row my-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <form class="d-flex input-group-sm w-100 mt-2 mb-3" role="form" action="{{URL::to('/khoa-truong')}}" method="GET">
                            ...
                            <div class="table-responsive">
                                <table class="table bg-white rounded shadow-sm  table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="check-highlight">{{$item->KT_MA}}</td>
            ...
            <nav aria-label="Page navigation">
                <div class="text-center d-flex justify-content-center mt-3">
                    <ul class="pagination pagination-sm m-t-none m-b-none ">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $all_college->previousPageUrl().$add }}"><i class="fas fa-angle-left"></i></a>
                            </li>
                        @endif
                        {{-- Pagination Elements --}}
                        @for ($key=0; $key+1<=$all_college->lastPage(); $key++)
                                @if ($all_college->currentPage() === $key + 1)
                                    <li class="page-item active">
                                        <a class="page-link" href="{{ $all_college->url($key + 1).$add }}">{{ $key + 1 }}</a>
                                    </li>
                                @else
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $all_college->url($key + 1).$add }}">{{ $key + 1 }}</a>
                        ...
                        @if ($all_college->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $all_college->nextPageUrl().$add }}"><i class="fas fa-angle-right"></i></a>
                            </li>
                        @else
