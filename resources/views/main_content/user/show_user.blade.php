                    ...
                    <div class="col-lg-10 d-flex justify-content-center align-items-center">
                        <div class="card m-3">
                            <div class="card-body p-4">
                                <h4 class="fw-bold">{{$info->ND_HOTEN}}</h4>
                                @if($info->KT_MA != null)
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mt-3 mb-sm-0">
                                        ...
                                        <a href="./tag.php"><span class="badge bg-info rounded-3 fw-semibold me-1 mb-1">#tsv</span></a>
                                        <a href="#"><span class="badge bg-info rounded-3 fw-semibold me-1 mb-1">#k49</span></a>
                                        <a href="#"><span class="badge bg-info rounded-3 fw-semibold me-1 mb-1">#pass_sach</span></a>
                                        <a href="#"><span class="badge bg-info rounded-3 fw-semibold me-1 mb-1">#ung_dung</span></a>
                                        <a href="#"><span class="badge bg-info rounded-3 fw-semibold me-1 mb-1">#lay_y_kien</span></a>
                                        <a href="#"><span class="badge bg-info rounded-3 fw-semibold me-1 mb-1">#pass_sach</span></a>
                                        <a href="#"><span class="badge bg-info rounded-3 fw-semibold me-1 mb-1">#tsv</span></a>
                                        <a href="#"><span class="badge bg-info rounded-3 fw-semibold me-1 mb-1">#k49</span></a>
                                    </div>
                                </div>
                            </div>
